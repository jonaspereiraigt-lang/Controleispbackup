...
async def get_providers(current_user=Depends(get_current_user)):
    ...
    for provider in providers:
        ...
        provider_stat = ProviderStats(
            ...
            created_at=provider.get("created_at", datetime.now(timezone.utc).isoformat()),
...
async def create_provider_by_admin(provider_data: dict, current_user=Depends(get_current_admin)):
    ...
    try:
        ...
        provider = Provider(
            ...
            nome_fantasia=provider_data.get("nome_fantasia", provider_data.get("name", "")),
            ...
            bairro=provider_data.get("bairro", "Centro"),
            is_active=True,
            approved=True,
